    ...
    <LayoutPage>
      <div className={stls.storiesOnMainPage}>
        ...
        >
          ...
          <div>
            Вспоминая начало своего пути, стоит упомянуть, что родилась
            я в Москве в пятницу 13-е и всё детство провела, занимаясь
            компьютерами вместе с братьями. Старший из нас — преподаватель
            информатики, младший — инженер по информационной безопасности.
            <br />
            ...
            <br />
            <br />
            На текущий день занимаюсь разработкой уже около пяти лет.
            <br />
