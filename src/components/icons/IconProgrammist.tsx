...
type TypeIconProgrammistProps = any;

export const IconProgrammist = ({ classNames }: TypeIconProgrammistProps) => {
    ...
    <div className={cn(classNames)}>
      ...
      >
        ...
        <path
          ...
          fill={colors.beta}
        />
        <path d="M85.7031 0H14.2969V4.75H85.7031V0Z" fill={colors.beta} />
        <path
