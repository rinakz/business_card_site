  ...
  return (
    <div className={stls.projectContainer}>
      <div className={stls.header}>
        <div className={stls.projectTitle}>{t("card.digital")}</div>
      ...
      <div className={stls.info}>
        <div style={{ display: "flex", gap: "40px", flexWrap: "wrap" }}>
          <div className={stls.cardContainer}>
            ...
            <span>{t("work.digital.sphere")}</span>
          </div>
          <div className={stls.cardContainer}>
            <div className={stls.iconContainer}>
              <IconPosition /> {t("work.position")}
            </div>
            <span>{t("work.digital.position")}</span>
          </div>
          <div className={stls.cardContainer}>
            <div className={stls.iconContainer}>
              <IconPeriod /> {t("work.period")}
            </div>
            <span>{t("work.digital.period")}</span>
          </div>
        </div>
        <div className={stls.infoContainer}>
          ...
          <div>{t("work.digital.first")}</div>
          <div>{t("work.digital.second")}</div>
          <div>{t("work.digital.third")}</div>
          <div>{t("work.digital.fourth")}</div>
        </div>
      </div>
    </div>
  );
